...
Guardamos y segimos operando sacando nuestra primera *"l"*
...
Procedemos ha hacer ceros abajo
...
Procedemos a calcular el ultimo l

```{r}
l43 <- A[4,3]/A[3,3];(l43)
```

Convertimos por ultimo la ultima fila 
...
Le agregamos a este los valores de los pivotes que calculamos con anterioridad
...
Llamamos la matriz *A* a exepcion de la ccolumna 5

```{r}
U <- A[,1:4];(U)
```

Multiplicamos U y L para que nos de la matriz A
